...
$(function() {
    $.fn.AddKanbanCard = function(options) {
        ...
        var title = $('<div class="kanban_card_title"/>');
        title.append('<div class="expand_collapse_arrow expand">Expand/Collapse</div>');
        title.append(opts.card.title);
        html.append(title);
        ...
        html.find(".expand_collapse_arrow").click(function() {
...
//            html.append('<div class="action edit"/>').text("x");
//            html.append('<div class="action delete"/>');
//            html.append('<div class="action comments"/>');
